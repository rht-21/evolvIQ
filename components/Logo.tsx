    ...
    <Link href="/" className="flex items-center gap-2">
      ...
      >
        ...
        <g id="SVGRepo_iconCarrier">
          ...
          <g>
            <path
              d="m152.16 76c-4.5-3.15-51.77 44.84-50.25 48.77s16.93 3.7 19 6.09-16.74 44.47-13.25 47.2c2.62 2 49.83-44.23 49.13-48.38s-13.36-3.37-16.13-6 14.72-45.41 11.5-47.68z"
              className="fill-primary"
            ></path>
          </g>
          <path
            d="m11.15 147.17c2.17 0 15.49-3.55 17.67-4.89s-.4-8.91-2.07-9.25-15.75 3.73-17.67 4.89-.08 9.28 2.07 9.25z"
            className="dark:fill-white fill-neutral-800"
          ></path>
          <path
            d="m8.36 97.94c-1.7-1.74.58-8.44 3.17-8.47s14.95 4.09 16.47 5.53-.27 8.17-3.17 8.47-14.6-3.62-16.47-5.53z"
            className="dark:fill-white fill-neutral-800"
          ></path>
          <path
            d="m34.5 67.22c-1.09-2.18 3.14-7.85 5.61-7.09s7.89 4.87 8.79 6.68-2.76 7.69-5.61 7.09-7.59-4.3-8.79-6.68z"
            className="dark:fill-white fill-neutral-800"
          ></path>
          <path
            d="m24 196.51c-2.43-.12-5.31-6.58-3.44-8.37s8-4.47 10.13-4.4 5.36 6.17 3.44 8.37-7.5 4.52-10.13 4.4z"
            className="dark:fill-white fill-neutral-800"
          ></path>
          <path
            d="m241.72 104.39c-1.64-.17-10.78 1.87-12.52 3s .88 8.66 2.11 9.14 11-2 12.52-3-.47-8.97-2.11-9.14z"
            className="dark:fill-white fill-neutral-800"
          ></path>
          <path
            d="m219.86 88.45c-2.43-.09-5.38-6.52-3.52-8.33s13.66-7.32 15.74-7.26 5.57 5.83 3.67 8-13.22 7.68-15.89 7.59z"
            className="dark:fill-white fill-neutral-800"
          ></path>
          <path
            d="m250 142c2.06 1.29 1.41 8.34-1.1 9s-15.49-.47-17.27-1.56-1.65-8 1.1-9 15.01.13 17.27 1.56z"
            className="dark:fill-white fill-neutral-800"
          ></path>
          <path
            d="m238.12 177.63c1.72 1.72-.52 8.44-3.11 8.49s-8.52-2.18-10-3.64.21-8.17 3.11-8.49 8.11 1.75 10 3.64z"
            className="dark:fill-white fill-neutral-800"
          ></path>
        </g>
      </svg>
